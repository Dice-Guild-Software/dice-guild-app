...
#### Long Range
If a unit's target is outside a weapon's half range band and in range of its Long range band it suffers -1 to its Accuracy rolls.
### Save Rolls
